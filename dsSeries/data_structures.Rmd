...
And finally, we can take values corresponding to some operation that results in `TRUE` or `FALSE`.
...
We actually don't have to create Boolean object before using it. R indexing is ridiculously (dangerously?) flexible.
