...
Note that there are many R packages that work with various APIs, so if you're looking to work with data from a site that has an API, definitely see if something already exists.
