...
<span class="emph">Pandoc</span> is a universal converter, allowing documents to flop from one format to another.  It reads the markdown, HTML, $\LaTeX$, and everything else and converts it to an HTML, pdf etc. document.  
