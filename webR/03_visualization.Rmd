...
By default the plot is interactive with hoverover information, but you can add a lot more too it (my own theme cleans up gridlines, zero reference line etc.).
