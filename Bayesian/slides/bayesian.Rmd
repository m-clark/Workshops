---
title: "Become a Bayesian in 10 minutes"
output: 
...
> <p class="fragment"> If I repeat this study precisely an infinte number of times, and I calculate a 95% interval each time, then 95% of those  intervals will contain the true parameter.</p>

Or

> <p class="fragment">What's the probability the parameter falls in this interval?</p>
...
## 
For common models and extensions, it is as easy to run a Bayesian version
