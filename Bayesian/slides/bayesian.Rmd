...
## {data-transition="fade" data-transitionSpeed="slow"}
...
> <p class="fragment"> If I repeat this study precisely an infinite number of times, and I calculate a 95% interval each time, then 95% of those  intervals will contain the true parameter.</p>
...
- <p class="fragment">Guards against overfitting</p>
...
<p class='fragment'>Posterior distribution</p>
...
<p class="fragment">Prior belief</p>

<p class="fragment">Prior research</p>

<p class="fragment">Known approaches that work well in the modeling context</p>
...
## Which of the following is R code for the Bayesian model? {data-transition="none"}
...
<img src="../../img/stan_logo.png" style="display:block; margin: 0 auto;">


## {data-transition="zoom" data-autoslide="15000"}
...
## {data-transition="zoom"  data-autoslide="50"}
...
<p class='fragment' style="text-align:center; font-size:200%"> Can you do any less?!</p>
