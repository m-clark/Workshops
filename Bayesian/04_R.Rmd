...
The <span class="pack">rstanarm</span> is a package that allows you to specify models in the standard R format`r margin_note("The 'arm' in rstanarm is for 'applied regression modeling', which is *NOT* the title of Gelman's book no matter what he says.")`.  While this is very limiting, it definitely covers a lot of the usual statistical ground.  As such, it enables you to be a Bayesian for any of the very common glm settings, including mixed and additive models.
...
Other functions of note allow the ability to change priors, enable posterior predictive checking etc. The following shows example code.
...
The brms package also has a lot of the same functionality for post model inspection.
