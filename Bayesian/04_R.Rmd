...
The <span class="pack">rethinking</span> package accompanies the text, Statistical Rethinking by Richard McElreath.  This is a great resource for learning Bayesian Analysis while using Stan under the hood. You can do more from the other packages mentioned, but if you can also run your model here, you might get even more to play with.  Like <span class="pack">rstanarm</span> and <span class="pack">brms</span>, you might be able to use it to produce starter Stan code as well, that you can then manipulate and use via <span class="pack">rstan</span>.
