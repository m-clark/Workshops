...
- <span class="pack">bayesplot</span>: diagnostic plots and other useful tools

`r tufte::margin_note('Example plots from bayesplot')`
```{r bayesplotEx, eval=T, echo=FALSE, dev='svg', fig.align='center', fig.width=4, fig.height=3}
...
```{r nuts, eval=T, echo=FALSE, dev='svg', fig.align='center', fig.width=4, fig.height=3}
