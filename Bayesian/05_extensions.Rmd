...
```{r bayesplotEx, eval=F, echo=FALSE, dev='svg', fig.align='center', fig.width=4, fig.height=3, cache=TRUE}
...
```{r nuts, eval=F, echo=FALSE, dev='svg', fig.align='center', fig.width=4, fig.height=3, cache=TRUE}
