...
Install and load the <span class="pack">ggplot2movies</span> package. Look at the help file for the `movies` data set.
...
Use <span class="func">mutate</span> and the <span class="func">scale</span> function to create a centered version of the rating variable.  A centered variable is one whose mean has been subtracted from it. The process will take the following form:
...
- group by action *and* Action *or* Drama
