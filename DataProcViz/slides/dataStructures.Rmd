...
<span class="objclass"></span>Vectors form the basis of R data structures.

Two main types- <span class="objclass"></span> and <span class="objclass"></span>, but I will treat lists separately.

Here is an R <span class="objclass"></span>vector. The *elements* of the vector are numeric values.
...
<span class="objclass">data.frame</span>s are a very commonly used data structure. 
