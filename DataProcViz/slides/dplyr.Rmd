...
<span class="func">rbind.fill</span>: Combine data.frames by row, filling in missing columns.

<span class="func">mapvalues</span>/revalue: replace values
...
<span class="func">select</span>: grab columns
  ...
  - select helpers: <span class="func">one</span>\_of, <span class="func">starts</span>\_with, <span class="func">num_range</span> etc.
...
- <span class="func">n</span>, <span class="func">n</span>\_distinct, <span class="func">nth</span>, <span class="func">n</span>\_groups, <span class="func">count</span>, <span class="func">recode</span>, <span class="func">between</span>
...
- <span class="func">spread</span>: complement of unite
...
I find the <span class="pack">dplyr</span> grammar to be clear for a lot of standard data processing.
