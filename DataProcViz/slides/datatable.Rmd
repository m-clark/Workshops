...
Faster methods are great to have. Especially for group-by and joins.

Drawbacks:

- You use data.frames way more than you will data.tables, and will frequently forget it doesn't work like a data.frame
...
If speed and/or memory is (potentially) 